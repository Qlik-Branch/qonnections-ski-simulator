...
function Header(props) {
  ...
  return (
    <div className="Header">
        ...
        {!props.raceFinished && <img className="qonnections" src={qonnectionsLogo} alt="Qonnections 2019" />}
        {props.raceFinished && <div className="actionButton nextSkier" onClick={nextSkier}>Next Skier</div>}
